...
public class C_ifElseIf {
    ...
    public void testSimpleIfElseIfStatement(){
        ...
        * */
        ...
        if(num == 1){
            ...
            // 은도끼를 고른 경우
            System.out.println("욕심이 과하지는 않지만 그래도 거직말을 하고 있구나!");
        }else if(num == 3) {
            // 쇠도끼를 고른 경우
            System.out.println("정직하구나 금도끼, 은도끼, 쇠도끼 모두 다 가져가거라!");
        }else{
    ...
    public void testNestedIfElseIfStatement(){
        ...
        System.out.println("학생의 점수를 입려해 주세요.");
        ...
        if(grade.equals("F")){
            System.out.println(name + " 학생은 F등급 입니다. 재수강하세요");
        }else if(grade.equals("D")){
            System.out.println(name + " 학생은 D등급 입니다. 재수강이 필요해 보입니다.");
        }else if(grade.equals("D+")){
            System.out.println(name + " 학생은 D+등급 입니다. D보단 낫지만 그래도 재수강이 필요해 보입니다.");
        }else{
