...
public class B_ifElse {
    ...
    public void testSimpleIfElseStstement() {
        /*
         * [if-else 표현식]
         * if(조건식){
         *      조건식이 true 일 때 실행할 내용
         *  }else {
         *  조건식이 fslse 일 때 실행할 내용
         *  }
         *
         * */
         ...
         * 홀수가 아니면 "입력하신 숫자는 짝수입니다."라고 출력하는 프로그램을 작성해 보자
    ...
    public void testNestedIfElseStstement() {
         ...
         * 단, 0이면 "0입니다"를 출력
         * 조건과 상관 없이 프로그램이 종료되면 "프로그램이 종료됩니다."를 출력
         *
         * */
        Scanner scr = new Scanner(System.in);
