...
public class Application03 {
    public static void main(String[] args) {
        ...
        * 이중 연결 리스트는 이전 요소도 링크하여 이전 요소로 쉽게 접근하기 위해 고안된 자료 구조이다.
        *
        * LinkedList 는 이중 연결 리스트를 구현한 것이며,
        * 역시 List 를 상속받아 ArrayList 와 사용하는 방법이 거의 유사하다.
        ...
        * */
        ...
        System.out.println(linkedList.isEmpty()); // 비었는지 확인하는 메소드

        /*
        * ArrayList 와 LinkedList 의 차이
        *
        * ArrayList 의 장점
        * - 내부적을 배열을 사용하기 때문에 인덱스의 접근이 매우 빠르다.
        * - 메모리 사용량이 적다.
        * ArrayList 의 단점
