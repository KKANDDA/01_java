...
public class Application06 {
    public static void main(String[] args) {
        ...
        * return 은 자신을 호출한 구문으로 복귀하는 갓을 의미한다.
        ...
        * 반환값이 없느 경우 return 을 생략해도 컴파일러가 자동으로 추가하지만,
        ...
        * */
        ...
        System.out.println(returnValue); // String returnValue 에 담아서 출력할 수도
        System.out.println(app6.test()); // 메소드를 바로 담아서 출력할 수도 있다.
