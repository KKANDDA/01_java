...
public class Application01 {
    public static void main(String[] args) {
        ...
        /*
        * 패키지란?
        * 서로 관령 있는 클래스 또는 인터페이스 등을 모아 하나의 묶음으로 단위를 구성하는 것을 말한다.
        ...
        * */
        ...
        // 이전에 만든 Calculator 클래스를 사용해서 satatic 과 non-static 메소드 호출

        // 1. non-static 메소드 호출
        main.java.com.ohgiraffers.section01.method.Calculator calc
                = new main.java.com.ohgiraffers.section01.method.Calculator();
