...
public class Application01 {
    public static void main(String[] args) throws Exception{
        ...
        /*
        * 예외처리
        * 자발 프로그램 작성 시 자바 문법에 맞지 않는 경우 코드를 컴파일 하려고 할 때 컴파일 에러를 발생시킨다.
        * 엄밀히 말하면 문법상의 오류이다.
        * 혹은 자바 문법에 맞게 박성하여 컴파일에 문제가 없더라도 실행되면서 예상치 못하게 오류가 발생할 수 있다.
        ...
        * 발생할 수 있는 상황을 예약하고 처리할 수 있는 미약한 오류를 의미한다.
        * */
