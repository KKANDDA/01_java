...
public class Application01 {
    public static void main(String[] args) {
        ...
        * */
        ...
        /*
        * 형변환의 종류와 규칙
        * 1. 자동 형변환 (묵시적 형변환) : 컴파일러가 자동으로 수행하주는 타입 변환
        ...
        *   2-1. 자동 형변환이 적용되지 않는 경우에는 강제 형변환이 필요하다.
        *
        *
        * */

        // 작은 자료형에서 큰 자료형으로 자동 형병환한다.
        // 데이터 손실이 발생하지 않기 때문에 컴파일러가 자동으로 처리해 준다.
        ...
        // int result1 =num1 *num2; long은 int에 담을 수 없다.

        // 정수는 실수로 자동 형변환된다.
        // 정수는 실수로 변경할 때 소수점 자리가 없어도 실수 형태로 표현이 가능하다.
