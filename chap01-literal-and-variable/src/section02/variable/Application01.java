...
public class Application01 {
    public static void main(String[] args) {
        ...
        1. 값의 의미를 부여하기 위한 목적
         (의미 전달이 쉬워야 코드를 읽기 쉬워지고,
         협업 및 유지보수에 유리하기 때문이다.)

        2. 한번 저장해 둔 값을 재사용하기 위한 목적
         (변수를 이용하여 코드를 작성하면
         값을 변경할 때 보다 간편하게 변경할 수 있다.
        ...
        System.out.println("첫 달 김과장님 보너스를 포함한 급여;"+(100+20)+"만 원");
        System.out.println("둘 째 달 김과장님 보너스를 제외한 급여"+100+"만 원");
        ...
        System.out.println("첫 달 김과장님 보너스를 포함한 급여 :"+(salary+bonus)+"만 원");
