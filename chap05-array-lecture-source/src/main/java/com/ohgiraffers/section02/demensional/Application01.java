...
public class Application01 {
    public static void main(String[] args) {
        ...
        * */
        ...
        iaaay1[0] = new int[5];
        iaaay1[1] = new int[5];
        iaaay1[2] = new int[5]; // 가변 배열

        iarray2 = new int[3][5]; // 정변 배열

        // 0번 인덱스에 접근 후 값 출력


            for (int i = 0; i < iaaay1[0].length; i++) {
                System.out.print(iaaay1[0][i] + "");
            }
            System.out.println();

            for (int i = 0; i < iaaay1[1].length; i++) {
                System.out.print(iaaay1[1][i] + "");
            }
            System.out.println();

            for (int i = 0; i < iaaay1[2].length; i++) {
                System.out.print(iaaay1[2][i] + "");
            }
        System.out.println();

        for(int i = 0; i < iaaay1.length; i++){
            for (int j = 0; j < iaaay1[i].length; j++) {
                System.out.print(iaaay1[i][j] + "");
            }
            System.out.println();
        }
