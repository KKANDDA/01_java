...
public class Application {
    public static void main(String[] args) {
        ...
        * */
        ...
        String result2 = (num2 > 0) ? "양수다." : "양수가 아니다.";  // ? 는 앞이 참 뒤가 거짓.

        System.out.println("num1 은 " + result1);
        System.out.println("num2 는 " + result2);
        ...
        String result3 = (num3 > 0) ? "양수다." : (num3 == 0)?  "0이다." : "음수다."; // 앞서 참이 나오면 뒤로는 더 계산을 하지 않는다.
        String result4 = (num4 > 0) ? "양수다." : (num4 == 0)?  "0이다." : "음수다."; // num4 가 0 보다 크지 않기에 다음 연산으로 넘어간다.
        String result5 = (num5 > 0) ? "양수다." : (num5 == 0)?  "0이다." : "음수다."; // num5 rk  0 보다 작고, 0 이 아니기에 거짓을 출력한다.
