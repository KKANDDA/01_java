...
public class Application01 {
    public static void main(String[] args) {
        ...
        *
        * 논리 연산자의 종류
        * 1. 논리 연결 연산자 : 두 개의 피 연산자를 가지는 이항 연산자이며, 연산자의 결합 방향은 왼쪽에서 오른쪽이다.
        ...
        * */
        ...
        System.out.println("true 와 false 의 논리 and 연산 : " + (true && true));
        System.out.println("false 와 true 의 논리 and 연산 : " + (false && true));
        System.out.println("false 와 fales 의 논리 and 연산 : " + (false && false));

        System.out.println("true 와 true 의 논리 or 연산 : " + (true || true));
        System.out.println("true 와 fslse 의 논리 or 연산 : " + (true || false));
        System.out.println("false 의 false 의 논리 or 연산 : " + (false || false));
