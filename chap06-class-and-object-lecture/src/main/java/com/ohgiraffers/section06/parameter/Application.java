...
public class Application {
    public static void main(String[] args) {
        ...
        * */
        ...
        pt.testVariableLengthArrayParameter("홍길동"); // 가변은 안 넘겨도..
        pt.testVariableLengthArrayParameter("유관순", "볼링"); // 하나만 넣어도..
        pt.testVariableLengthArrayParameter("이순신","볼링", "축구", "당구"); // 두 개도..
        pt.testVariableLengthArrayParameter("신사임당", new String[]{"테니스","서예", "당구"}); // 배열로 묶어도..
