...
public class Application01 {
    public static void main(String[] args) {
        ...
        * 이 때 기본타입의 데이터를 먼저 인스턴스로 변환 후 사용해야 하는 데
        * 8가지에 해당하는 기본 타입의 데이터를 인스턴스화 할 수 있도록 하는 클래스를 패터클래스(wrapper class)라고 한다.
        ...
        * 오토박싱, 오토언박싱
        *
        * JDK 1.5 부터는 박싱과 언박싱이 필요한 상황에서 컴파일러가 자동으로 처리해준다.
        ...
        * */
        ...
        // 기본 타입고 ㅏㅑ페러클래스 타입은 == 연산로 비교 가능하다.
