...
public class Application {
    public static void main(String[] args) {
        ...
        * */
        ...
        carArray[0] = new Car/*클래스도 자료형*/("페라리", 300);
        carArray[1] = new Car("람보르기니", 350);
        carArray[2] = new Car("롤스", 250);
        carArray[3] = new Car("부가티", 400);
        carArray[4] = new Car("소나타", 1000);
        ...
        System.out.println("----------------------------------");
        for(Car car/*클래스 변수명을 선언*/ : carArray/*배열명*/) { // 배열을 알아서 길이까지 대입됨.. 순서대로 대입함.. 놀라워라
            car.driveMaxSpeed();
        }
